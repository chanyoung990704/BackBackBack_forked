package com.aivle.project.post.comment.integration;
...
import com.aivle.project.post.comment.dto.CommentCreateRequest;
import com.aivle.project.post.comment.dto.CommentResponse;
import com.aivle.project.post.comment.dto.CommentUpdateRequest;
import com.aivle.project.post.comment.service.CommentsService;
...
class CommentControllerIntegrationTest {
	...
	void delete_shouldSoftDeleteComment() throws Exception {
		...
		// then
		var comment = entityManager.find(com.aivle.project.post.comment.entity.CommentsEntity.class, created.id());
