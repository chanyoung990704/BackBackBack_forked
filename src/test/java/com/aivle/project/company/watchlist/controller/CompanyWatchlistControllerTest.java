package com.aivle.project.company.watchlist.controller;
...
class CompanyWatchlistControllerTest {
	...
	void getWatchlist_shouldReturnList() throws Exception {
		...
		com.aivle.project.company.watchlist.dto.WatchlistResponse response = new com.aivle.project.company.watchlist.dto.WatchlistResponse(List.of(
			new com.aivle.project.company.watchlist.dto.WatchlistItem(1L, 10L, "기업A", "00000001", "000001", "메모A", now),
			new com.aivle.project.company.watchlist.dto.WatchlistItem(2L, 11L, "기업B", "00000002", "000002", "메모B", now)
		));
