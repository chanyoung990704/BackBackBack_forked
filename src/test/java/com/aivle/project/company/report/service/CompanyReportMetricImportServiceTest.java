...
class CompanyReportMetricImportServiceTest {
	...
	void importMetrics_reusesUnpublishedVersion() {
		...
		QuartersEntity quarter = quartersRepository.save(QuartersEntity.create(
			...
			3,
			20253,
			com.aivle.project.company.report.quarter.support.QuarterCalculator.startDate(
				com.aivle.project.company.report.quarter.support.QuarterCalculator.parseQuarterKey(20253)),
			com.aivle.project.company.report.quarter.support.QuarterCalculator.endDate(
				com.aivle.project.company.report.quarter.support.QuarterCalculator.parseQuarterKey(20253))
		));
