package com.aivle.project.auth.user.service;
...
import com.aivle.project.auth.user.entity.EmailVerificationEntity;
import com.aivle.project.auth.user.entity.UserEntity;
import com.aivle.project.auth.user.entity.UserStatus;
import com.aivle.project.auth.user.entity.VerificationStatus;
import com.aivle.project.auth.user.repository.EmailVerificationRepository;
